...
*/
bool CheckWord(string wordname)
{
	string line;
...
void ParseWordlist(string wordlist, vector<string>& vec)
{
...
void main()
{
	...
	for (int i = 0; i < n; i++)
	{
		...
		playerWordlistMap.insert(std::pair<string, vector<string>>(playerName, wordvec));
